...
cd ../nginx
sed -e "s/SERVERNAME/$3 $4/g" -e "s/WEBSITE_DIRECTORY/$3/g" -e "s/PORT/$2/g" node-template > $3.conf
...
cd ../nginx
sed -e "s/SERVERNAME/$3 $4/g" -e "s/WEBSITE_DIRECTORY/$3/g" -e "s/PORT/$2/g" node-ssl-template > $3.conf
